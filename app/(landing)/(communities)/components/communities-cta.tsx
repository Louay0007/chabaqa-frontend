          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            ...
            <div className="w-full grid grid-cols-3 gap-3 sm:gap-6 mb-10">
              <div className="flex flex-col items-center">
                ...
                <h3 className="text-sm sm:text-xl font-semibold text-gray-800">Build</h3>
                <p className="text-xs sm:text-sm text-gray-500">Invite members</p>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <h3 className="text-sm sm:text-xl font-semibold text-gray-800">Engage</h3>
                <p className="text-xs sm:text-sm text-gray-500">Share & host</p>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <h3 className="text-sm sm:text-xl font-semibold text-gray-800">Monetize</h3>
                <p className="text-xs sm:text-sm text-gray-500">Earn revenue</p>
              </div>
            </div>

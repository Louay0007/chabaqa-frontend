...
export default function SettingsPage() {
    ...
    const [fullName, setFullName] = useState(
        userType === "creator" ? "John Smith" : "Jane Doe",
    );
    const [email, setEmail] = useState(
        userType === "creator" ? "john@example.com" : "jane@example.com",
    );
    const [bio, setBio] = useState(
        userType === "creator"
            ? "Fitness coach and wellness expert"
            : "Fitness enthusiast",
    );
    const [phone, setPhone] = useState("+1 234 567 8900");
    const [location, setLocation] = useState("New York, USA");
    const [website, setWebsite] = useState(
        userType === "creator" ? "www.johnsmith.com" : "",
    );

    // Creator-specific states
    const [businessName, setBusinessName] = useState("Smith Fitness Academy");
    const [businessDescription, setBusinessDescription] = useState(
        "Professional fitness training and wellness coaching",
    );
                                ...
                                <CardContent className="space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <WanisAssistButton
                                            ...
                                            context="User profile bio — short personal description, max 160 characters"
                                        />
                                        ...
                                        <>
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <WanisAssistButton
                                                    ...
                                                    context="Creator business description — what the business offers to community members"
                                                />
                                            </div>
                                        </>
                                    )}
                            ...
                            <TabsContent value="branding">
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription>
                                            Customize your community's look and
                                            feel
                                        </CardDescription>
                                    </CardHeader>
                                    <CardContent className="space-y-6">
                                            ...
                                            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-4 bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg border border-purple-200">
                                                <div>
                                                    ...
                                                    <p className="text-sm text-gray-600">
                                                        {currentPlan ===
                                                            "starter" &&
                                                            "29 TND/mois - Parfait pour commencer"}
                                                        {currentPlan ===
                                                            "growth" &&
                                                            "79 TND/mois - Développez votre communauté"}
                                                        {currentPlan ===
                                                            "pro" &&
                                                            "199 TND/mois - Toutes les fonctionnalités & analytiques"}
                                                    </p>
                                                </div>
                        ...
                        <DialogContent>
                            ...
                            <div className="bg-red-50 border border-red-200 rounded-lg p-4 my-4">
                                ...
                                <ul className="text-xs text-red-700 space-y-1 list-disc list-inside">
                                    <li>
                                        All your communities will be permanently
                                        deleted
                                    </li>
                                    <li>
                                        All your content and data will be lost
                                    </li>
                                    <li>

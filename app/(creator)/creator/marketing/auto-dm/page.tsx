...
export default function AutoDmPage() {
  const { selectedCommunityId, selectedCommunity, isLoading: isLoadingCommunities } = useCreatorCommunity()
    ...
    <div className="max-w-4xl mx-auto px-6 py-8 space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              When turned on, your welcome message is automatically sent as a Direct Message every
              time someone joins this community.
            </p>
          </div>
          <button
      ...
      <div className="rounded-2xl border border-dashed border-gray-200 p-6">
        ...
        <ol className="space-y-2 text-sm text-gray-500 list-decimal list-inside">
          <li>
            A new member joins <strong>{communityName}</strong> (free join, invite link, or after payment).
          </li>
        ...
        <p className="mt-4 text-xs text-gray-400">
          Auto DMs are sent as real Direct Messages — members can reply, and you will see their reply

...
export default function EmailCampaignsPage() {
    ...
    const [editCampaign, setEditCampaign] = useState<EmailCampaign | null>(
        null,
    );
    const [editTitle, setEditTitle] = useState("");
    const [editSubject, setEditSubject] = useState("");
    const [editContent, setEditContent] = useState("");
    const [editSendingTime, setEditSendingTime] = useState<"now" | "scheduled">(
        "now",
    );
    const [editScheduledDate, setEditScheduledDate] = useState("");
    const [editScheduledTime, setEditScheduledTime] = useState("");

    const [testCampaign, setTestCampaign] = useState<EmailCampaign | null>(
        null,
    );
    const [testEmailAddress, setTestEmailAddress] = useState("");
    const [sendingTestEmail, setSendingTestEmail] = useState(false);

    const [recipientsCampaign, setRecipientsCampaign] =
    ...
    const [recipientsStatus, setRecipientsStatus] = useState<
        "all" | "pending" | "sent" | "failed" | "bounced"
    >("all");
    const [recipientsOpened, setRecipientsOpened] = useState<
    ...
    const fetchStats = useCallback(
        async (options?: { silent?: boolean }) => {
            ...
            try {
                ...
                setStatsError(null);
                const response =
                    await emailCampaignsApi.getCampaignStats(
                        selectedCommunityId,
                    );
                setStats(response);
            } catch (error: any) {
    ...
    const saveEditCampaign = async () => {
        ...
        try {
            ...
            if (editSendingTime === "scheduled") {
                ...
                scheduledAt = toUtcIsoFromLocalDateTime(
                    editScheduledDate,
                    editScheduledTime,
                );
    ...
    const loadRecipients = async (
        ...
        try {
            ...
            const response = await emailCampaignsApi.getCampaignRecipients(
                campaign._id,
                {
                    page,
        ...
        <PageShell className="container mx-auto space-y-6">
            ...
            <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
                        ...
                        >
                            ...
                            <SelectContent>
                                ...
                                <SelectItem value="course_update">
                                    Course update
                                </SelectItem>
                                <SelectItem value="inactive_user_reactivation">
                    ...
                    <EmailCampaignList
                        ...
                        onPageChange={(page) =>
                            fetchCampaigns(page, activeFilters)
                        }
                        onSendCampaign={(campaign) =>
                            runCampaignAction(
                                campaign,
                                () =>
                                    emailCampaignsApi.sendCampaign(
                                        campaign._id,
                                    ),
                        ...
                        onCancelCampaign={(campaign) =>
                            runCampaignAction(
                                campaign,
                                () =>
                                    emailCampaignsApi.cancelCampaign(
                                        campaign._id,
                                    ),
                        ...
                        onDuplicateCampaign={(campaign) =>
                            runCampaignAction(
                                campaign,
                                () =>
                                    emailCampaignsApi.duplicateCampaign(
                                        campaign._id,
                                    ),
                                "Campaign duplicated",
                            )
                        ...
                        onDeleteCampaign={(campaign) => {
                            ...
                            runCampaignAction(
                                campaign,
                                () =>
                                    emailCampaignsApi.deleteCampaign(
                                        campaign._id,
                                    ),
                                "Campaign deleted",
                            );
            ...
            >
                <DialogContent className="sm:max-w-[640px]">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Update title, content, and scheduling for this
                            campaign.
                        </DialogDescription>
                    </DialogHeader>
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <WanisAssistButton
                                value={editContent}
                                onAccept={(newText) => setEditContent(newText)}
                                context="Editing email campaign content for community members"
                            />
                        </div>
                        <div className="space-y-2">
                            <Label>When to send</Label>
                            <Select
                                value={editSendingTime}
                                onValueChange={(value) =>
                                    setEditSendingTime(value as any)
                                }
                            >
                                <SelectTrigger>
                                    <SelectValue />
            ...
            >
                <DialogContent className="sm:max-w-[520px]">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Send this campaign content to your email before
                            launch.
                        </DialogDescription>
                    </DialogHeader>
                    <div className="space-y-2">
            ...
            <Dialog
                ...
                onOpenChange={(open) => !open && setRecipientsCampaign(null)}
            >
                <DialogContent className="sm:max-w-[860px]">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            {recipientsCampaign
                                ? `Campaign: ${recipientsCampaign.title}`
                                : "Campaign recipients"}
                        </DialogDescription>
                    </DialogHeader>
                    <div className="grid grid-cols-2 gap-3">
                                ...
                                {recipientsLoading ? (
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            colSpan={5}
                                        >
                                            No recipients found for the selected
                                            filters.
                                        </td>
                                    </tr>
                                ) : (
                    ...
                    <DialogFooter className="justify-between sm:justify-between">
                        <div className="text-sm text-muted-foreground">
                            Page {recipientsPage} of {recipientTotalPages} (
                        ...
                        <div className="flex gap-2">
                            ...
                            <Button
                                ...
                                size="sm"
                                disabled={
                                    recipientsPage >= recipientTotalPages ||
                                    recipientsLoading ||
                                    !recipientsCampaign
                                }
                                onClick={() =>

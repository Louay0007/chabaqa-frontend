...
export default function MessageCampaignsPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div>
        <h1 className="text-2xl font-bold">Messages Campaigns</h1>
        <p className="text-gray-500">SMS messaging tools are being finalized.</p>
      </div>
      ...
      <Card className="p-8 flex items-start gap-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            Email campaigns are fully available now. SMS channel support will be released in a dedicated phase.
          </p>
        </div>
      </Card>
    </div>

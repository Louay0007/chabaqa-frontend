...
export function DashboardSidebar({ user, onLogout }: DashboardSidebarProps) {
    ...
    const navigation: NavEntry[] = [
        ...
        },
        {
            ...
            requiredPermission:
                CommunityPermission.ANALYTICS_VIEW as CommunityPermissionValue,
        },
        ...
        // ── Manage Content ──
        {
            ...
            expandable: true,
            requiredPermission:
                CommunityPermission.CONTENT_MANAGE as CommunityPermissionValue,
            items: [
                ...
                {
                    title: "Channels",
                    href: `${communityBasePath}/channels`,
                    icon: Hash,
                },
                {
                    title: "Posts",
                    href: communityFeedUrl,
                    icon: FileText,
                    external:
                        communityFeedUrl.startsWith("/") &&
                        !communityFeedUrl.startsWith("/creator"),
                },
            ],
        },
        ...
        // ── Manage Revenue ──
        {
            ...
            expandable: true,
            requiredPermission:
                CommunityPermission.FINANCE_VIEW as CommunityPermissionValue,
            items: [
                {
                    title: "Subscriptions",
                    href: "/creator/monetization/subscriptions",
                    icon: CreditCard,
                },
                {
                    title: "Payouts",
                ...
                {
                    title: "Promo Codes",
                    href: "/creator/monetization/promo-codes",
                    icon: TicketPercent,
                },
                {
                    title: "Manual Payments",
                    href: "/creator/monetization/manual-payments",
                    icon: CreditCard,
                },
            ],
        },
        ...
        // ── Manage Growth ──
        {
            ...
            expandable: true,
            requiredPermission:
                CommunityPermission.MARKETING_MANAGE as CommunityPermissionValue,
            items: [
                {
                    title: "Email Campaigns",
                    href: "/creator/marketing/emails",
                    icon: Mail,
                },
                {
    ...
    const topEntries = visibleNav.filter(
        (e) =>
            !e.expandable &&
            ["Overview", "Communities", "Analytics"].includes(
                (e as NavItem).title,
            ),
    );
    ...
    const configEntries = visibleNav.filter(
        (e) =>
            !e.expandable &&
            ["Team & Roles", "Customize", "Integrations"].includes(
                (e as NavItem).title,
            ),
    );
    const systemEntries = visibleNav.filter(
        (e) =>
            !e.expandable &&
            ["Notifications", "Help & Support"].includes((e as NavItem).title),
    );

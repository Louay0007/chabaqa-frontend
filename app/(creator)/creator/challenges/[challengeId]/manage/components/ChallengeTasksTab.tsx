...
export default function ChallengeTasksTab({
    ...
    const validateEditingTaskState = () => {
        ...
        const result = validateManageTask(
            ...
            challengeTasks.map((task) => Number(task.day)),
            Number(
                challengeTasks.find((task) => task.id === editingTask.id)?.day,
            ),
        );
    ...
    const getEditError = (key: string) =>
        editTaskErrors[key] || fieldErrors[key];
            ...
            <CardHeader>
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <CardDescription>
                            Manage the daily tasks for your challenge
                        </CardDescription>
                    </div>
                    <Dialog
                        open={isAddOpen}
                    ...
                    >
                        ...
                        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto pointer-events-auto">
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    Create a new daily task. Fields marked with
                                    * are required.
                                </DialogDescription>
                            </DialogHeader>
                            <div className="space-y-6 py-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <WanisAssistButton
                                        ...
                                        context="Challenge task description"
                                    />
                                    {getNewError("description") && (
                                        <p className="text-sm text-red-500">
                                            {getNewError("description")}
                                ...
                                <div className="space-y-2">
                                    ...
                                    <WanisAssistButton
                                        ...
                                        context="Challenge task deliverable description"
                                    />
                                    {getNewError("deliverable") && (
                                        <p className="text-sm text-red-500">
                                            {getNewError("deliverable")}
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="taskInstructions">
                                        Instructions{" "}
                                        <span className="text-red-500">*</span>
                                    </Label>
                                    <Textarea
                                    ...
                                    <WanisAssistButton
                                        ...
                                        context="Challenge task detailed instructions (Markdown supported)"
                                    />
                                    {getNewError("instructions") && (
                                        <p className="text-sm text-red-500">
                                            {getNewError("instructions")}
                                ...
                                <div className="space-y-4 border rounded-md p-4 bg-muted/20">
                                    ...
                                    {Object.keys(newTaskErrors).some((key) =>
                                        key.startsWith("resources."),
                                    ) && (
                                        <p className="text-sm text-red-500">
                                            Each resource must include title,
                                            valid type, and a valid http/https
                                            URL.
                                        </p>
                                    )}
                                                ...
                                                (res, idx) => (
                                                    ...
                                                    >
                                                        ...
                                                        <Button
                                                            ...
                                                            onClick={() =>
                                                                handleRemoveResourceFromNewTask(
                                                                    idx,
                                                                )
                                                            }
                                                        >
                                ...
                                <div className="space-y-2">
                                    ...
                                    <WanisAssistButton
                                        ...
                                        context="Challenge task notes and tips for participants"
                                    />
                                </div>
                            </div>
                            <DialogFooter>
                ...
                <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto pointer-events-auto">
                    ...
                    {editingTask && (
                        <div className="space-y-6 py-4">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="editTaskDeliverable">
                                    Deliverable{" "}
                                    <span className="text-red-500">*</span>
                                </Label>
                                <Textarea
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="editTaskInstructions">
                                    Instructions{" "}
                                    <span className="text-red-500">*</span>
                                </Label>
                                <Textarea
                            ...
                            <div className="space-y-4 border rounded-md p-4 bg-muted/20">
                                <Label>Resources (Optional)</Label>
                                {Object.keys(editTaskErrors).some((key) =>
                                    key.startsWith("resources."),
                                ) && (
                                    <p className="text-sm text-red-500">
                                        Each resource must include title, valid
                                        type, and a valid http/https URL.
                                    </p>
                                )}
                                <div className="grid gap-4">
                                    <div className="grid grid-cols-[1fr,1fr,auto] gap-2 items-end">
                                ...
                                {editingTask.resources &&
                                    editingTask.resources.length > 0 && (
                                        <div className="space-y-2 mt-2">
                                            {editingTask.resources.map(
                                                (res, idx) => (
                                                    <div
                                                        key={idx}
                                                        className="flex items-center justify-between text-sm bg-background p-2 rounded border"
                                                    >
                                                        ...
                                                        <Button
                                                            ...
                                                            className="h-6 w-6 p-0 text-red-500"
                                                            onClick={() =>
                                                                handleRemoveResourceFromEditingTask(
                                                                    idx,
                                                                )
                                                            }
                                                        >

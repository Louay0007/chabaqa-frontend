...
export default function ChallengeDetailsTab({
    ...
    const totalRewards =
        (challenge.completionReward || 0) + (challenge.topPerformerBonus || 0);
            ...
            <div className="lg:col-span-2 space-y-6">
                <EnhancedCard>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Update your challenge basic details
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <WanisAssistButton
                                ...
                                context="Challenge description — a summary of what participants will achieve"
                            />
                            {fieldErrors.description && (
                                <p className="text-sm text-red-500">
                                    {fieldErrors.description}
                        ...
                        <p className="text-xs text-muted-foreground">
                            Start and end dates are locked after challenge
                            creation.
                        </p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <Select
                                    ...
                                    onValueChange={(value) =>
                                        onInputChange("difficulty", value)
                                    }
                                >
                                    <SelectTrigger>
                                        <SelectValue />
                        ...
                        <div className="space-y-2">
                            ...
                            <WanisAssistButton
                                ...
                                context="Challenge notes — tips, guidance, or extra instructions for participants"
                            />
                        </div>
                    </CardContent>
                </EnhancedCard>

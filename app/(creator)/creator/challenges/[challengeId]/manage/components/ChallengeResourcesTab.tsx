            ...
            <CardHeader>
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <CardDescription>
                            Manage additional resources for your challenge
                        </CardDescription>
                    </div>
                    <Dialog open={isAddOpen} onOpenChange={setIsAddOpen}>
                        ...
                        <DialogContent>
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    Add a helpful resource for your challenge
                                </DialogDescription>
                            </DialogHeader>
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <WanisAssistButton
                                        ...
                                        context="Challenge resource description"
                                    />
                                </div>
                            </div>
                            <DialogFooter>
            ...
            <Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
                <DialogContent>
                    ...
                    {editingResource && (
                        <div className="space-y-4">
                            <div className="space-y-2">
                                <Label htmlFor="editResourceTitle">
                                    Resource Title
                                </Label>
                                <Input
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="editResourceType">
                                    Resource Type
                                </Label>
                                <Select
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="editResourceDescription">
                                    Description
                                </Label>
                                <Textarea

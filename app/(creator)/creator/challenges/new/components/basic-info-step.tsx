    ...
    return (
        <EnhancedCard>
            <CardHeader>
                ...
                <CardDescription>
                    Start with the fundamentals of your challenge
                </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                    ...
                    <WanisAssistButton
                        ...
                        context="Challenge description explaining what participants will achieve"
                    />
                    {getError("description") && (
                        <p className="text-sm text-red-500">
                            {getError("description")}
                ...
                <div className="space-y-4 rounded-lg border p-4">
                    <div className="flex items-center justify-between">
                        <div>
                            <Label htmlFor="sequentialProgression">
                                Sequential Progression
                            </Label>
                            <p className="text-xs text-muted-foreground mt-1">
                                Participants must complete previous tasks to
                                unlock the next one.
                            </p>
                        </div>
                        <Switch
                        ...
                        {formData.thumbnail ? (
                            ...
                            <div className="p-8">
                                ...
                                <p className="text-xs text-gray-500 mt-1">
                                    PNG, JPG up to 2MB (1920x1080 recommended -
                                    16:9)
                                </p>
                            </div>
                        )}

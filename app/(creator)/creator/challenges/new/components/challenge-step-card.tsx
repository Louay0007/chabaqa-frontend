                ...
                i === index
                    ? {
                          ...
                          resources: s.resources.filter(
                              (_: any, j: number) => j !== resourceIndex,
                          ),
                      }
                    : s,
            ),
            ...
            <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            value={step.title}
                            onChange={(e) =>
                                updateChallengeStep("title", e.target.value)
                            }
                            className={
                                stepError("title")
                ...
                <div className="space-y-2">
                    ...
                    <Textarea
                        ...
                        onChange={(e) =>
                            updateChallengeStep("description", e.target.value)
                        }
                        className={
                    ...
                    <WanisAssistButton
                        value={step.description}
                        onAccept={(newText) =>
                            updateChallengeStep("description", newText)
                        }
                        context="Challenge step description: what participants will learn or do in this step"
                    />
                    {stepError("description") && (
                        <p className="text-sm text-red-500">
                            {stepError("description")}
                ...
                <div className="space-y-2">
                    ...
                    <Textarea
                        ...
                        onChange={(e) =>
                            updateChallengeStep("deliverable", e.target.value)
                        }
                        className={
                    ...
                    <WanisAssistButton
                        value={step.deliverable}
                        onAccept={(newText) =>
                            updateChallengeStep("deliverable", newText)
                        }
                        context="Challenge step deliverable description: what participants should submit or complete"
                    />
                    {stepError("deliverable") && (
                        <p className="text-sm text-red-500">
                            {stepError("deliverable")}
                ...
                <div className="space-y-2">
                    ...
                    <Textarea
                        ...
                        onChange={(e) =>
                            updateChallengeStep("instructions", e.target.value)
                        }
                        className={
                    ...
                    <WanisAssistButton
                        value={step.instructions}
                        onAccept={(newText) =>
                            updateChallengeStep("instructions", newText)
                        }
                        context="Challenge step detailed instructions in Markdown format"
                    />
                    {stepError("instructions") && (
                        <p className="text-sm text-red-500">
                            {stepError("instructions")}
                    ...
                    {step.resources.length === 0 ? (
                        <div className="text-center py-4 border border-dashed border-gray-200 rounded-lg bg-gray-50">
                            ...
                            <p className="text-sm text-muted-foreground">
                                No resources added for this step
                            </p>
                        </div>
                    ) : (
                        <div className="space-y-3">
                            {step.resources.map((resource, resIndex) => (
                                <ChallengeResourceCard
                                    ...
                                    getError={(field) =>
                                        getError(
                                            `steps.${index}.resources.${resIndex}.${field}`,
                                        )
                                    }
                                />
                            ))}

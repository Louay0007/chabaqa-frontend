...
export function SpeakersTicketsStep({
    ...
    const getTicketError = (
        ...
        const ticketErrors =
            (errors.tickets as Record<number, Record<string, string>>) || {};
        return ticketErrors[index]?.[field];
    };

    const getSpeakerError = (
        index: number,
        field: string,
    ): string | undefined => {
        const speakerErrors =
            (errors.speakers as Record<number, Record<string, string>>) || {};
    ...
    return (
        <EnhancedCard>
            <CardHeader>
                ...
                <CardDescription>
                    Add speakers and ticket options for your event
                </CardDescription>
            </CardHeader>
                    ...
                    {formData.speakers.length === 0 ? (
                        <div className="text-center py-8 border-2 border-dashed border-gray-300 rounded-lg">
                            ...
                            <p className="text-muted-foreground mb-4">
                                Add speakers to showcase who will be presenting
                            </p>
                ...
                <div className="space-y-4">
                    ...
                    {formData.tickets.length === 0 ? (
                        <div className="text-center py-8 border-2 border-dashed border-gray-300 rounded-lg">
                            ...
                            <p className="text-muted-foreground mb-4">
                                Add ticket options for attendees to purchase
                            </p>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <WanisAssistButton
                                                    ...
                                                    context="Ticket description for an event"
                                                />
                                            </div>
                                        </div>
                                    </div>

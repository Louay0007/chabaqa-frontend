...
export default function EventDetailsTab({
    ...
    const totalRevenue = (event.tickets || []).reduce(
        (acc, ticket) => acc + (ticket.price || 0) * (ticket.sold || 0),
        0,
    );
            ...
            <div className="lg:col-span-2 space-y-6">
                <EnhancedCard>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Update your event basic details
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <WanisAssistButton
                                ...
                                context="Event description for an event management platform"
                            />
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <WanisAssistButton
                                value={event.notes || ""}
                                onAccept={(newText) =>
                                    handleInputChange("notes", newText)
                                }
                                context="Event notes and instructions for attendees"
                            />
                        </div>
                    </CardContent>
                </EnhancedCard>
                    ...
                    <CardContent>
                        <div className="space-y-4">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Event image is read-only here. Update the image
                                URL in your event details to change it.
                            </p>
                        </div>
                    </CardContent>
                </EnhancedCard>

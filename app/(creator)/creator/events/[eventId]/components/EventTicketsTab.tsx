...
const nextId = () =>
    `ticket_${Date.now()}_${Math.random().toString(36).slice(2, 8)}`;

export default function EventTicketsTab({
    event,
    onUpdateEvent,
}: EventTicketsTabProps) {
    ...
    const [newTicket, setNewTicket] =
        useState<TicketFormState>(createEmptyTicket());
    const [editingTicket, setEditingTicket] = useState<TicketFormState | null>(
        null,
    );
    ...
    const validateTicket = (ticket: TicketFormState): string | null => {
        ...
        if (ticket.quantity.trim()) {
            ...
            if (Number.isNaN(quantity) || quantity < 0)
                return "Ticket quantity must be 0 or greater";
    ...
    const handleAddTicket = () => {
        ...
        const created = {
            ...
            quantity: newTicket.quantity.trim()
                ? Number(newTicket.quantity)
                : undefined,
            sold: 0,
        };
        ...
        toast({
            title: "Ticket added",
            description: "Ticket added. Click Save Changes to persist.",
        });
    };
    ...
    const handleUpdateTicket = () => {
        ...
        const nextTickets = tickets.map((ticket) =>
            ticket.id === editingTicket.id
                ? {
                      ...
                      quantity: editingTicket.quantity.trim()
                          ? Number(editingTicket.quantity)
                          : undefined,
                      sold: Number(ticket.sold ?? 0),
                  }
                : ticket,
        ...
        toast({
            ...
            description: "Ticket updated. Click Save Changes to persist.",
        });
    };
    ...
    const handleDeleteTicket = (ticketId: string, sold: number) => {
        ...
        toast({
            ...
            description: "Ticket removed. Click Save Changes to persist.",
        });
    };
                    ...
                    >
                        ...
                        <DialogContent>
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    Create a new ticket option for your event
                                </DialogDescription>
                            </DialogHeader>
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <WanisAssistButton
                                        ...
                                        context="Event ticket description explaining what the ticket includes and its benefits"
                                    />
                                </div>
                            </div>
                            <DialogFooter>
                            ...
                            >
                                ...
                                <div className="flex items-center space-x-4">
                                    ...
                                    <Button
                                        ...
                                        title={
                                            hasSales
                                                ? "Cannot delete ticket with sales"
                                                : "Delete ticket"
                                        }
                                    >
                ...
                <DialogContent>
                    ...
                    {editingTicket && (
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="editTicketQuantity">
                                    Quantity
                                </Label>
                                <Input
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="editTicketDescription">
                                    Description
                                </Label>
                                <Textarea

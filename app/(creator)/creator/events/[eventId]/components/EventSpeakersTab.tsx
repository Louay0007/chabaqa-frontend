...
const nextId = () =>
    `speaker_${Date.now()}_${Math.random().toString(36).slice(2, 8)}`;

export default function EventSpeakersTab({
    event,
    onUpdateEvent,
}: EventSpeakersTabProps) {
    ...
    const [newSpeaker, setNewSpeaker] =
        useState<SpeakerFormState>(emptySpeaker());
    const [editingSpeaker, setEditingSpeaker] =
        useState<SpeakerFormState | null>(null);
    ...
    const handleAddSpeaker = () => {
        ...
        toast({
            title: "Speaker added",
            description: "Speaker added. Click Save Changes to persist.",
        });
    };
    ...
    const handleUpdateSpeaker = () => {
        ...
        toast({
            ...
            description: "Speaker updated. Click Save Changes to persist.",
        });
    };
    ...
    const handleDeleteSpeaker = (speakerId: string) => {
        ...
        toast({
            ...
            description: "Speaker removed. Click Save Changes to persist.",
        });
    };
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <WanisAssistButton
                                        ...
                                        context="Speaker biography for an event"
                                    />
                                </div>
                                <div className="space-y-2">
                                    <Label htmlFor="speakerPhoto">
                                        Photo URL
                                    </Label>
                                    <Input
                                        id="speakerPhoto"
                ...
                <DialogContent>
                    ...
                    {editingSpeaker && (
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="editSpeakerTitle">
                                    Title *
                                </Label>
                                <Input
                                    id="editSpeakerTitle"
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="editSpeakerPhoto">
                                    Photo URL
                                </Label>
                                <Input
                                    id="editSpeakerPhoto"
                    ...
                    <DialogFooter>
                        <Button onClick={handleUpdateSpeaker}>
                            Save Speaker
                        </Button>
                    </DialogFooter>
                </DialogContent>

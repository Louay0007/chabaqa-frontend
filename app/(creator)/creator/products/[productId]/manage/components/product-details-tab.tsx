...
export function ProductDetailsTab() {
    ...
    const thumbnail = Array.isArray(formData.images)
        ? formData.images[0] || ""
        : "";
            ...
            <div className="lg:col-span-2 space-y-6">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Title and description of your product
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <WanisAssistButton
                                ...
                                context="product description for a digital product listing"
                            />
                        </div>
                    </CardContent>
                </Card>
            ...
            <div className="space-y-6">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Main thumbnail for your product
                        </CardDescription>
                    </CardHeader>

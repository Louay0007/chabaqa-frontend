...
export function BasicInfoStep() {
    ...
    const thumbnailPreviewSrc =
        resolveImageUrl(formData.thumbnail) || formData.thumbnail;
    ...
    const onFiles = async (files: FileList | null) => {
        ...
        if (!/image\/(png|jpeg|jpg)/i.test(file.type)) {
            toast({
                ...
                description: "Please upload PNG or JPG.",
    ...
    return (
        <EnhancedCard>
            <CardHeader>
                ...
                <CardDescription>
                    Start with the fundamentals of your digital product
                </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                    ...
                    <WanisAssistButton
                        ...
                        context="new product description"
                    />
                    {errors.description && (
                        <p className="text-sm text-red-500 mt-1">
                            {errors.description}

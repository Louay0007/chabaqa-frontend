...
export function SessionEditForm({ session, sessionId }: SessionEditFormProps) {
    ...
    const validateForm = () => {
        ...
        if (!formData.description || formData.description.trim().length < 10) {
            errors.description =
                "Session description must be at least 10 characters.";
        }
        if (
            !formData.duration ||
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    Update your session information
                </CardDescription>
            </CardHeader>
            <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <WanisAssistButton
                            ...
                            context="Session description for a 1-on-1 or group session offering"
                        />
                        {validationErrors.description && (
                            <p className="text-sm text-red-500">
                                {validationErrors.description}
                    ...
                    <div className="space-y-2">
                        ...
                        <WanisAssistButton
                            ...
                            context="Additional notes and information for session participants"
                        />
                    </div>
                    ...
                    <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                        <div>
                            ...
                            <p className="text-sm text-gray-600 mt-1">
                                Make this session available for booking
                            </p>
                        </div>
                        <Switch

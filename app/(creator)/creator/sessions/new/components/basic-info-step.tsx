    ...
    return (
        <EnhancedCard>
            <CardHeader>
                ...
                <CardDescription>
                    Start with the fundamentals of your session
                </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                    ...
                    <WanisAssistButton
                        ...
                        context="Session description explaining what participants will learn or gain"
                    />
                    {validationErrors.description && (
                        <p className="text-sm text-red-500">
                            {validationErrors.description}
                ...
                <div className="space-y-2">
                    ...
                    <WanisAssistButton
                        value={formData.requirements}
                        onAccept={(newText) =>
                            handleInputChange("requirements", newText)
                        }
                        context="Session prerequisites and requirements for participants"
                    />
                </div>
            </CardContent>
        </EnhancedCard>

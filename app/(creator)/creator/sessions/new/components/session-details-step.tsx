    ...
    return (
        <EnhancedCard>
            <CardHeader>
                ...
                <CardDescription>
                    Define the format and what participants will receive
                </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
                <div className="space-y-2">
                    ...
                    <Select
                        ...
                        onValueChange={(value) =>
                            handleInputChange("sessionFormat", value)
                        }
                    >
                        <SelectTrigger>
                ...
                <div className="space-y-4">
                    <div className="flex items-center justify-between">
                        ...
                        <Button
                            ...
                            variant="outline"
                            size="sm"
                            onClick={() => addArrayItem("whatYoullGet")}
                        >
                        ...
                        <div key={index} className="flex space-x-2">
                            ...
                            {formData.whatYoullGet.length > 1 && (
                                <Button
                                    ...
                                    size="icon"
                                    onClick={() =>
                                        removeArrayItem("whatYoullGet", index)
                                    }
                                >
                                    <X className="h-4 w-4" />
                                </Button>
                ...
                <div className="space-y-2">
                    <Label htmlFor="preparationMaterials">
                    ...
                    <WanisAssistButton
                        value={formData.preparationMaterials}
                        onAccept={(newText) =>
                            handleInputChange("preparationMaterials", newText)
                        }
                        context="Session preparation materials describing what participants should bring or prepare"
                    />
                </div>

                <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg text-sm text-blue-900">
                    <strong>Note:</strong> Sessions are created as drafts. You
                    can publish them from the sessions page once you have an
                    active subscription.
                </div>
            </CardContent>
        </EnhancedCard>

...
export function ContentTab({
    ...
    const [editChapterSectionId, setEditChapterSectionId] = useState<
        string | null
    >(null);
    const [editChapterId, setEditChapterId] = useState<string | null>(null);
    const [editChapterVideoUrlError, setEditChapterVideoUrlError] = useState<
        string | null
    >(null);
    const [editChapterFormError, setEditChapterFormError] = useState<
        string | null
    >(null);
    ...
    const [newChapterVideoUrlError, setNewChapterVideoUrlError] = useState<
        string | null
    >(null);
    ...
    const validateChapterDraft = (chapter: {
        ...
        if (!title) {
            return {
                formError: "Chapter title is required.",
        ...
        if (!content && !videoUrl) {
            return {
                formError: "Add chapter content or a video URL.",
                videoError: null as string | null,
            };
        }
    ...
    const uploadNewChapterVideo = async (
        file: File,
    ): Promise<string | null> => {
        setIsUploading(true);
        try {
    ...
    const uploadExistingChapterVideo = async (
        sectionId: string,
        chapterId: string,
        file: File,
    ): Promise<string | null> => {
        setIsUploading(true);
        try {
            const result = await coursesApi.uploadChapterVideo(
                courseId,
                sectionId,
                chapterId,
                file,
            ...
            const updatedSection = updatedCourse?.sections?.find(
                (s: any) => String(s.id) === String(sectionId),
            );
            const updatedChapter = updatedSection?.chapitres?.find(
                (c: any) => String(c.id) === String(chapterId),
            );
            const newUrl =
                updatedChapter?.videoUrl || updatedChapter?.video_url || "";
            if (newUrl) {
    ...
    const saveEditSection = () => {
        ...
        void onUpdateSection(editSectionId, {
    ...
    const openEditChapter = (sectionId: string, chapter: any) => {
        ...
        setEditChapterVideoUrlError(
            getCreatorVideoUrlError(chapter.videoUrl || ""),
        );
    ...
    const handleDeleteSection = (sectionId: string) => {
        const confirmed = window.confirm(
            "Delete this section? This will also remove all its chapters.",
        );
        if (!confirmed) return;
            ...
            <CardHeader>
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <CardDescription>
                            Manage your course sections and chapters
                        </CardDescription>
                    </div>
                    <Dialog>
                        ...
                        <DialogContent>
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    Create a new section to organize your course
                                    content
                                </DialogDescription>
                            </DialogHeader>
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <WanisAssistButton
                                        ...
                                        context="Course section description"
                                    />
                                </div>
                            </div>
                            <DialogFooter>
                ...
                <div className="space-y-6">
                    ...
                    >
                        <DialogContent>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <WanisAssistButton
                                        value={editSectionDescription}
                                        onAccept={(text) =>
                                            setEditSectionDescription(text)
                                        }
                                        context="Course section description"
                                    />
                                </div>
                            ...
                            <DialogFooter>
                                <Button type="button" onClick={saveEditSection}>
                                    Save
                                </Button>
                            </DialogFooter>
                        </DialogContent>
                    ...
                    >
                        <DialogContent className="max-w-2xl">
                            ...
                            <div className="space-y-4">
                                        ...
                                        onChange={(e) => {
                                            ...
                                            void (async () => {
                                                if (
                                                    ...
                                                    return;
                                                await uploadExistingChapterVideo(
                                                    editChapterSectionId,
                                                    editChapterId,
                                                    file,
                                                );
                                ...
                                <div className="space-y-2">
                                    ...
                                    <WanisAssistButton
                                        ...
                                        context="Course chapter content"
                                    />
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <WanisAssistButton
                                        ...
                                        context="Course chapter instructor notes"
                                    />
                                </div>
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="flex items-center space-x-2">
                                        <Switch
                                            checked={editChapter.isPreview}
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            ...
                                            disabled={editChapter.isPreview}
                                        />
                                    </div>
                                </div>
                            ...
                            <DialogFooter>
                                <Button type="button" onClick={saveEditChapter}>
                                    Save
                                </Button>
                            </DialogFooter>
                        </DialogContent>
                                    ...
                                    <DialogContent className="max-w-2xl">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <Label htmlFor="chapterVideoUrl">
                                                    Video URL (YouTube or
                                                    /uploads/...)
                                                </Label>
                                                <Input
                                                    id="chapterVideoUrl"
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <WanisAssistButton
                                                    ...
                                                    context="New course chapter content"
                                                />
                                            </div>
                                            <div className="space-y-2">
                                                ...
                                                <WanisAssistButton
                                                    ...
                                                    context="New course chapter instructor notes"
                                                />
                                            </div>
                                            <div className="grid grid-cols-2 gap-4">
                                                <div className="flex items-center space-x-2">
                                                    ...
                                                    />
                                                    <Label htmlFor="chapterPreview">
                                                        Free Preview
                                                    </Label>
                                                </div>
                                                <div className="space-y-2">
                                                    <Label htmlFor="chapterPrice">
                                                        Individual Price
                                                        (optional)
                                                    </Label>
                                                    <Input

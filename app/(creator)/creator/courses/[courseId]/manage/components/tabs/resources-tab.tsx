...
export function ResourcesTab({ course, onRefresh }: ResourcesTabProps) {
    ...
    const allChaptersWithResources = (course.sections || []).flatMap(
        (section) =>
    ...
    const handleAddResource = async () => {
        if (!selectedSection || !selectedChapter) {
            toast({
                title: "Please select a section and chapter",
                variant: "destructive",
            });
            return;
        }
    ...
    const chaptersForSelectedSection = selectedSection
        ? (course.sections || []).find((s) => s.id === selectedSection)
              ?.chapters || []
        : [];
            ...
            <CardHeader>
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <CardDescription>
                            Manage additional resources for your course chapters
                        </CardDescription>
                    </div>
                    <Dialog
                    ...
                    >
                        ...
                        <DialogContent>
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    Add a helpful resource to a chapter
                                </DialogDescription>
                            </DialogHeader>
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    >
                                        ...
                                        <SelectContent>
                                            {chaptersForSelectedSection.map(
                                                (chapter) => (
                                                    <SelectItem
                                                        key={chapter.id}
                                                        value={chapter.id}
                                ...
                                <div className="space-y-2">
                                    ...
                                    <WanisAssistButton
                                        ...
                                        context="course resource description"
                                    />
                                </div>
                            </div>
                            <DialogFooter>
                ...
                <div className="space-y-6">
                    {allChaptersWithResources.length === 0 ? (
                        <div className="text-center py-8 text-muted-foreground">
                            ...
                            <p>
                                No chapters found. Add sections and chapters
                                first.
                            </p>
                        </div>
                    ) : (
                        allChaptersWithResources.map((item) => (
                            <div
                                key={`${item.sectionId}-${item.chapterId}`}
                                                        ...
                                                        <Button
                                                            ...
                                                            onClick={() => {
                                                                toast({
                                                                    ...
                                                                    description:
                                                                        "Resource deletion will be available soon.",
                                                                });
                                                            }}
                                                        >

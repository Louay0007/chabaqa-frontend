            ...
            <div className="lg:col-span-2 space-y-6">
                <EnhancedCard>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Update your course basic details
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <WanisAssistButton
                                value={formData.description || ""}
                                onAccept={(newText) =>
                                    onInputChange("description", newText)
                                }
                                context="This is a short course description for previews"
                            />
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <WanisAssistButton
                                value={formData.longDescription || ""}
                                onAccept={(newText) =>
                                    onInputChange("longDescription", newText)
                                }
                                context="This is a detailed course description for a learning platform"
                            />
                        </div>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                ...
                                <Button
                                    ...
                                    size="sm"
                                    onClick={() =>
                                        onAddArrayItem("learningObjectives")
                                    }
                                >
                        ...
                        <div className="space-y-2">
                            ...
                            <WanisAssistButton
                                value={formData.notes || ""}
                                onAccept={(newText) =>
                                    onInputChange("notes", newText)
                                }
                                context="These are course notes and tips for students"
                            />
                        </div>
                    </CardContent>
                </EnhancedCard>

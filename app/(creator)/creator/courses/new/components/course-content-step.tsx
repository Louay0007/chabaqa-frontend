...
export function CourseContentStep({
    ...
    const totalChapters = formData.sections.reduce(
        (acc, section) => acc + section.chapters.length,
        0,
    );
    const hasValidationError = validationErrors?.courseContent || false;

    const [uploadingChapterIds, setUploadingChapterIds] = useState<
        Record<string, boolean>
    >({});
    const [chapterVideoUrlErrors, setChapterVideoUrlErrors] = useState<
        Record<string, string>
    >({});

    const setChapterVideoUrlError = (
        chapterId: string,
        error: string | null,
    ) => {
    ...
    const uploadVideoForChapter = async (
        sectionId: string,
        chapterId: string,
        file: File,
    ) => {
        console.log(
            "🎬 [VIDEO UPLOAD] Starting upload for chapter:",
            chapterId,
        );
        console.log(
            "   📁 File:",
        ...
        try {
            ...
            if (url) {
                ...
                setChapterVideoUrlError(
                    chapterId,
                    getCreatorVideoUrlError(url),
                );
                console.log(
                    "✅ [VIDEO UPLOAD] Video URL set in chapter state:",
                    url,
                );
            } else {
    ...
    return (
        <EnhancedCard
            className={hasValidationError ? "border-2 border-red-500" : ""}
        >
            <CardHeader>
                <CardTitle className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                        <Badge variant="secondary">
                            {formData.sections.length} sections, {totalChapters}{" "}
                            chapters
                        </Badge>
                    ...
                    >
                        ...
                        {hasValidationError && (
                            <p className="text-sm text-red-500 mb-6">
                                At least one section with one chapter is
                                required
                            </p>
                        )}
                        <Button
                                            ...
                                            <div className="space-y-3">
                                                {section.chapters.map(
                                                    (chapter, chapterIndex) => {
                                                        const chapterTitleError =
                                                            chapterValidationErrors[
                                                                `chapter:${chapter.id}:title`
                                                            ];
                                                        const chapterVideoError =
                                                            chapterVideoUrlErrors[
                                                                chapter.id
                                                            ] ||
                                                            chapterValidationErrors[
                                                                `chapter:${chapter.id}:videoUrl`
                                                            ];
                                                        const chapterContentVideoError =
                                                            chapterValidationErrors[
                                                                `chapter:${chapter.id}:contentVideo`
                                                            ];
                                                            ...
                                                            >
                                                                ...
                                                                <div className="space-y-1 mb-3">
                                                                    ...
                                                                    <WanisAssistButton
                                                                        ...
                                                                        context="Course chapter content describing what students will learn"
                                                                    />
                                                                ...
                                                                <div className="space-y-1 mb-3">
                                                                    ...
                                                                    <WanisAssistButton
                                                                        ...
                                                                        context="Instructor notes with tips or additional instructions for course chapter"
                                                                    />
                                                                </div>

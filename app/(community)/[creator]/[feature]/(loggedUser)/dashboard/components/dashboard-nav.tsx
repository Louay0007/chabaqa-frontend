                ...
                items: [
                    {
                        ...
                        icon: Shield,
                        permission: CommunityPermission.ROLES_MANAGE,
                    },
                    {
                        label: "Members",
                        href: `${basePath}/admin/members`,
                        icon: Users,
                        permission: CommunityPermission.MEMBERS_VIEW,
                    },
                    {
                        label: "Invitations",
                        href: `${basePath}/admin/invitations`,
                        icon: UserPlus,
                        permission: CommunityPermission.MEMBERS_MANAGE,
                    },
                ],
            },
            {
                ...
                items: [
                    {
                        ...
                        href: `${basePath}/admin/content`,
                        icon: FileText,
                        permission: CommunityPermission.CONTENT_MANAGE,
                    },
                    {
                        label: "Post Moderation",
                        href: `${basePath}/admin/moderation`,
                        icon: MessageSquare,
                        permission: CommunityPermission.POSTS_MODERATE,
                    },
                ],
            },
            {
                ...
                items: [
                    {
                        label: "Marketing",
                        href: `${basePath}/admin/marketing`,
                        icon: Megaphone,
                        permission: CommunityPermission.MARKETING_MANAGE,
                    },
                    {
                        label: "Affiliates",
                        href: `${basePath}/admin/affiliates`,
                        icon: Users,
                        permission: CommunityPermission.AFFILIATES_MANAGE,
                    },
                ],
            },
            {
                ...
                items: [
                    {
                        ...
                        icon: BarChart3,
                        permission: CommunityPermission.ANALYTICS_VIEW,
                    },
                    {
                        label: "Finance",
                        href: `${basePath}/admin/finance`,
                        icon: DollarSign,
                        permission: CommunityPermission.FINANCE_VIEW,
                    },
                ],
            },
            {
                ...
                items: [
                    ...
                    {
                        label: "Gamification",
                        href: `${basePath}/admin/gamification`,
                        icon: Trophy,
                        permission:
                            CommunityPermission.COMMUNITY_MANAGE_SETTINGS,
                    },
                    {
                        ...
                        href: `${basePath}/admin/support`,
                        icon: HeadphonesIcon,
                        permission: CommunityPermission.SUPPORT_MANAGE,
                        badge: "Limited",
                ...
                items: [
                    {
                        ...
                        href: `${basePath}/moderator/queue`,
                        icon: MessageSquare,
                        permission: CommunityPermission.POSTS_MODERATE,
                    },
                    {
                        label: "Pinned Content",
                        href: `${basePath}/moderator/pinned`,
                        icon: Pin,
                        permission: CommunityPermission.POSTS_MODERATE,
                    },
                ],
                ...
                items: [
                    {
                        ...
                        href: `${basePath}/moderator/members`,
                        icon: Eye,
                        permission: CommunityPermission.MEMBERS_VIEW,
                    },
                ],
        ...
        sections.push(
            ...
            },
            {
                ...
                items: [
                    {
                        label: "Member Lookup",
                        href: `${basePath}/support/members`,
                        icon: Users,
                        permission: CommunityPermission.MEMBERS_VIEW,
                    },
                    {
                        label: "Support Queue",
                        href: `${basePath}/support/queue`,
                        icon: HeadphonesIcon,
                        permission: CommunityPermission.SUPPORT_MANAGE,
...
const NavItemComponent = memo(function NavItemComponent({
    ...
    return (
        <Link
            ...
            onClick={
                item.backendRequired ? (e) => e.preventDefault() : undefined
            }
        >
            <Icon
                className={cn(

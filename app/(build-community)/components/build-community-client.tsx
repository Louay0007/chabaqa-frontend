...
export default function CommunityPage() {
        ...
        switch (currentStep) {
            ...
            case 2:
                ...
                if (formData.joinFee === "paid") {
                    return (
                        formData.feeAmount && parseFloat(formData.feeAmount) > 0
                    );
                }
                return true;
            case 3:
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            ...
                            <WanisAssistButton
                                value={formData.bio}
                                onAccept={(newText) =>
                                    updateFormData("bio", newText)
                                }
                                context="Community bio description during onboarding — tell potential members what this community is about"
                            />
                        </div>
                    </div>
                );
                ...
                return (
                    <div className="space-y-8">
                        <div>
                            ...
                            <p className="text-gray-600 mb-6">
                                Configure your community access and pricing.
                            </p>
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center space-x-4 p-4 border-2 border-gray-200 rounded-xl hover:border-[#8e78fb] transition-colors">
                                            ...
                                            />
                                            <div className="flex items-center space-x-3 flex-1">
                                                <div className="w-10 h-10 rounded-lg flex items-center justify-center community-gradient-btn">
                ...
                return (
                    <div className="space-y-6">
                        <div>
                            ...
                            <p className="text-gray-600 mb-6">
                                Connect your community with social platforms.
                            </p>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center space-x-4">
                                    <div className="w-12 h-12 rounded-xl flex items-center justify-center community-gradient-facebook">
    ...
    const communities = [
        ...
        },
        {
            ...
            icon: (
                <div className="w-6 h-6 bg-red-200 rounded-full opacity-60" />
            ),
        },
        {
            name: "Travel Stories",
        ...
        },
        {
            ...
            icon: (
                <div className="w-6 h-6 bg-violet-200 rounded-lg opacity-60" />
            ),
        },
        {
            name: "Startup Club",
            ...
            icon: (
                <div className="w-5 h-5 bg-emerald-200 rounded-full opacity-60" />
            ),
        },
    ];
                                        ...
                                        {step < 3 && (
                                            <div
                                                className={`w-12 h-1 mx-2 rounded-full transition-all duration-300 ${
                                                    step < currentStep
                                                        ? "community-step-connector-active"
                                                        : "bg-gray-200"
                                                }`}
                                            />
                                        )}
                            ...
                            {success && (
                                <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-xl">
                                    <p className="text-green-700 text-sm">
                                        Votre communauté a été créée avec
                                        succès!
                                    </p>
                                </div>
                            )}

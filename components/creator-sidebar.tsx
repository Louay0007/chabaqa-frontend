        ...
        try {
            ...
            const [coursesRes, challengesRes, sessionsRes, postsRes] =
                await Promise.all([
                    ...
                    api.posts.getByCreator(userId, { page: 1, limit: 1 }).catch(
                        () =>
                            ({
                                posts: [],
                                pagination: {
            ...
            setCounts({
                courses: formatNumber(
                    coursesRes.data?.pagination?.total ||
                        coursesRes.data?.length ||
                        0,
                ),
                challenges:
                    challengesCount > 0 ? `${challengesCount} Active` : "0",
                sessions: formatNumber(
                    sessionsRes.data?.pagination?.total ||
